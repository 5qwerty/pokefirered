...
static const struct DungeonMapInfo sDungeonInfo[] = {
    {
        ...
        .name = sMapsecName_CINNABARLIBRARY,
...
static const u8 sMapFlyDestinations[][3] = {
    ...
    [MAPSEC_OBSIDIAN_CITY       - MAPSECS_KANTO] = {MAP(OBSIDIAN_CITY),                         SPAWN_OBSIDIAN_CITY},
    [MAPSEC_TURQUOISE_CITY      - MAPSECS_KANTO] = {MAP(TURQUOISE_CITY),                        SPAWN_TURQUOISE_CITY},
...
static u8 GetMapsecType(u8 mapsec)
{
    ...
    case MAPSEC_OBSIDIAN_CITY:
        return FlagGet(FLAG_WORLD_MAP_OBSIDIAN_CITY) ? MAPSECTYPE_VISITED : MAPSECTYPE_NOT_VISITED;
    case MAPSEC_TURQUOISE_CITY:
        return FlagGet(FLAG_WORLD_MAP_TURQUOISE_CITY) ? MAPSECTYPE_VISITED : MAPSECTYPE_NOT_VISITED;
